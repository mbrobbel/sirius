...
if(VCPKG_CROSSCOMPILING)
  list(APPEND _options -DFLATBUFFERS_BUILD_FLATC=OFF
       -DFLATBUFFERS_BUILD_FLATHASH=OFF)
  if(VCPKG_TARGET_IS_OSX OR VCPKG_TARGET_IS_IOS)
    # The option may cause "#error Unsupported architecture"
    list(APPEND _options -DFLATBUFFERS_OSX_BUILD_UNIVERSAL=OFF)
  endif()
endif()
...
if(flatc_path)
  ...
  file(
    APPEND "${CURRENT_PACKAGES_DIR}/share/flatbuffers/flatbuffers-config.cmake"
